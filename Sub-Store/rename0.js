 ...
 *
 * 新增功能：支持输出三字母国家代码 (ISO 3166-1 Alpha-3)
 * 使用参数 [out=code3] 或 [out=alpha3] 输出三字母代码
 *
 *** 主要参数
 ...
 * [in=quan] 识别英文全称
 * [in=code3] 或in=alpha3 识别三字母代码

 *
 * [out=]   输出节点名可选参数: (cn或zh ，us或en ，gq或flag ，quan ，code3或alpha3)
 *          对应：(中文，英文缩写 ，国旗 ，英文全称，三字母代码) 默认中文
 *          例如 [out=en] 或 out=us 输出英文缩写
 *          例如 [out=code3] 或 out=alpha3 输出三字母代码
 *** 分隔符参数
 *
 * [fgf=]   国旗分隔符，默认为空；
 ...
 * 例如     https://raw.githubusercontent.com/llxo/proxycr/refs/heads/main/substore/rename.js#flag&blkey=GPT>新名字+NF
 * [blgd]   保留: 家宽 IPLC ˣ² 等
...
function operator(pro) {
  ...
  if (inname !== "") {
    ...
    inputList = [ZH, FG, QC, EN, CODE3];  // 添加CODE3到自动检测列表
  }
